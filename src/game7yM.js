...
const { Deck, deckType } = require("./cards");
const { Player, Game, STATUS } = require("./game");

const deck = deckType.spanish40;
...
class Game7yM extends Game {
  ...
  */
  ...
  play() {
    ...
    //
    // TODO: Some implemenation guideline is ready for debugging
    this.nextRound();
  }
